...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
        <form action="{{url('updateevent/'.$data['event']->event_id)}}" method="POST" enctype="multipart/form-data">
                @csrf 
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <label for="eventname">Event Name:</label>
                        <input type="text" class="form-control" name="eventname" value="{{$data['event']->event_name}}">
                    </div>
                    <div class="col-md-6">
                        <label for="location">Location:</label>
                        <input type="text" class="form-control" name="location" value="{{$data['event']->location}}">
                    </div>
                    <div class="col-md-12">
                        <label for="eventdescr">Event Description:</label>
                        <textarea class="form-control" name="eventdescr" id="descript">{{$data['event']->event_description}}</textarea>
                    </div>
                    <div class="col-md-6">
                        <label for="eventtime">Event Time: </label>
                        <input type="datetime-local" id="eventtime" name="eventtime" value="{{$data['event']->event_date}}">
                    </div>
                    ...
                    <div class="col-md-6">
                        <h4>Current Event Banner</h4> 
                        @if($data['event']->event_flyer)
                        <img src="{{asset('assets/uploads/events/'.$data['event']->event_flyer)}}" alt="Event Banner" height='400px' width='350px'>
                        @endif
                    </div>
                    <div class="col-md-6" >
                        <h4>Event Banner New Image</h4> 
                    ...
                    <div class="col-md-6">
                        <div class="col-md-6" id='early' style="display: none ;">
                            ...
                            <label for="earlybirdquan"> Disable or Enable:</label>
                            <input type="radio" id="html" name="earlyrad" value="1">
                            <label for="html">Disable</label><br>
                            <input type="radio" id="css" name="earlyrad" value="0">
                            <label for="css">Enable</label><br>
                        </div>
                        ...
                        <div class="col-md-6" id='advanced' style="display: none ;">
                            ...
                            <label for="earlybirdquan"> Disable or Enable:</label>
                            <input type="radio" id="html" name="adnvancedrad" value="1">
                            <label for="html">Disable</label><br>
                            <input type="radio" id="css" name="advancedrad" value="0">
                            <label for="css">Enable</label><br>
                        </div>
                        <div class="col-md-6" id='vip' style="display: none ;">
                            ...
                            <label for="earlybirdquan"> Disable or Enable:</label>
                            <input type="radio" id="html" name="viprad" value="1">
                            <label for="html">Disable</label><br>
                            <input type="radio" id="css" name="viprad" value="0">
                            <label for="css">Enable</label><br>
                        </div>
                        <div class="col-md-6" id='flash' style="display: none ;">
                            ...
                            <label for="earlybirdquan"> Disable or Enable:</label>
                            <input type="radio" id="html" name="flashrad" value="1">
                            <label for="html">Disable</label><br>
                            <input type="radio" id="css" name="flashrad" value="0">
                            <label for="css">Enable</label><br>
                        </div>
                    </div>
